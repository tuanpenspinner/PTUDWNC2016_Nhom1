...
router.get("/nameCustomer/:accountNumber",authCustomer, customerController.getNameCustomer);//Lấy name customer theo checking account number 
...
router.post("/updateNameCustomer",authCustomer, customerController.updateNameCustomer); //Api đổi tên customer
router.post("/updateListReceivers",authCustomer, customerController.updateListReceivers); //Api cập nhật danh sách người nhận

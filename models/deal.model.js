...
const dealSchema = new Schema({
    ...
    time: {
        type: Date, default: null //thời gian chuyển tiền
        , required: true
    },
...
module.exports = {
    addDeal: async (receiverAccountNumber, transfererAccountNumber, time, amount, content, isTransfered, payFeeBy, type) => {
        try {
            const deal = await Deal.create({ receiverAccountNumber, transfererAccountNumber, time, amount, content, isTransfered, payFeeBy, type });
